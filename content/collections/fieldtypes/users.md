...
The Users fieldtype is a [Relate fieldtype](/reference/fieldtypes/relate), which means the users will be saved as IDs.
...
Use the [Relate tag](/reference/tags/relate) to loop through the IDs and fetch the user data.
