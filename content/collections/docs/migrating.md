...
### File and folder naming conventions {#naming-conventions}
...
### Renamed/removed variables {#renamed-variables}
...
### Bloodhound is now integrated Search {#search}
...
### Removed and changed fieldtypes {#fieldtypes}
